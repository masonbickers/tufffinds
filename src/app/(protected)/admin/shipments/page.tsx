...
export default function ShipmentsPage() {
  return (
    <AdminShell active="shipments">
      <AdminPage>
        <AdminPageHeader
          eyebrow="Operations"
          title="Shipments"
          description="A dedicated workspace for coordinating deliveries and tracking fulfilment."
        />

        <section
          aria-labelledby="shipments-coming-soon"
        ...
        >
          <div className="max-w-md">
            ...
            <h2
              id="shipments-coming-soon"
              className="mt-3 font-serif text-3xl text-[#302722] sm:text-4xl"
            >
              Coming soon
            </h2>
            <p className="mt-3 text-sm leading-6 text-[#766960]">
              We&apos;re building a simpler way to track shipments, delivery
              milestones and fulfilment updates.
            </p>
          </div>
        </section>
      </AdminPage>
