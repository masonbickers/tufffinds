...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Overlay + Sidebar */}
      <div className="overlay" data-state={menuOpen ? "show" : "hide"} onClick={closeMenu} />
      <aside
        id="site-sidebar"
        ref={sidebarRef}
        className="sidebar"
      ...
      >
        <div className="sidebar-header">
          <Image src="/CHANEL.png" alt="Logo" className="sidebar-logo" width={120} height={28} priority />
        ...
        <nav className="sidebar-links" role="menu">
          ...
          <a role="menuitem" href="#home" onClick={closeMenu} style={linkStyle(0)}>
            Home
          </a>
          <a role="menuitem" href="#services" onClick={closeMenu} style={linkStyle(1)}>
            Services
          </a>
          <a role="menuitem" href="#process" onClick={closeMenu} style={linkStyle(2)}>
            Process
          </a>
          <a role="menuitem" href="#testimonials" onClick={closeMenu} style={linkStyle(3)}>
            Reviews
          </a>
          <a role="menuitem" href="#contact" onClick={closeMenu} className="btn" style={linkStyle(4)}>
            Book a consult
          </a>
        </nav>
      ...
      <main>
        ...
        <section id="home" className="hero">
          <div className="hero-media">
            <Image className="hero-logo" src="/logo-01.png" alt="Tufffinds logo" width={320} height={320} priority />
        ...
        <section id="welcome" className="section welcome" data-anim="fade">
          <div className="container">
            <p className="eyebrow" data-anim="up">
              Personal styling • Sourcing • Discovery
            </p>
        ...
        <section id="services" className="section services-section" data-anim="fade">
          <div className="container">
            <h2 data-anim="up" style={{ fontStyle: "italic" }}>
              Services
            </h2>
            ...
            <div className="cards services">
              <article className="card service" data-anim="up">
                <Image className="service-icon" src="/CHANEL.png" alt="" width={64} height={64} aria-hidden />
                <h3>Wardrobe Edit</h3>
              ...
              <article className="card service" data-anim="up" style={{ transitionDelay: "80ms" }}>
                <Image className="service-icon" src="/GOYARD.png" alt="" width={64} height={64} aria-hidden />
                <h3>Event Styling</h3>
              ...
              <article className="card service" data-anim="up" style={{ transitionDelay: "160ms" }}>
                <Image className="service-icon" src="/HERMESTF.png" alt="" width={64} height={64} aria-hidden />
              ...
              <article className="card service" data-anim="up" style={{ transitionDelay: "240ms" }}>
                <Image className="service-icon" src="/SUNGLASSES.png" alt="" width={64} height={64} aria-hidden />
                <h3>Virtual Shop</h3>
        ...
        <section id="founders" className="section founders" data-anim="fade">
          <div className="container founders-wrap">
            ...
            <div className="founders-text">
              ...
              <blockquote className="founders-quote">“Tufffinds - The Ones Connected”</blockquote>
        ...
        <section id="contact" className="section alt" data-anim="fade">
          <div className="container narrow">
            ...
            <form className="contact-grid" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button className="btn" data-anim="up" style={{ transitionDelay: "240ms" }}>
                Send
              </button>
            </form>
            <p className="muted" data-anim="fade">
              Hook up Formspree/Netlify when you’re ready.
            </p>
          </div>
        </section>
        ...
        <section id="instagram" className="section" data-anim="fade">
          <div className="container">
            ...
            <div className="ig-grid">
              {/* External images: keep <img> with rule disabled OR add picsum.photos to next.config.js */}
            ...
            <div className="center" data-anim="up" style={{ transitionDelay: "180ms" }}>
              <a className="btn btn-outline" href="https://instagram.com" target="_blank" rel="noreferrer">
      ...
      <button id="toTop" className="to-top" aria-label="Back to top">
        ↑
      </button>
      ...
      <footer className="footer">
        <div className="container">
          <p>
            © <span id="year"></span> Personal Shopping by You. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
